...
import {faGlobe, faPalette, faUniversity, faImage, faUser} from "@fortawesome/free-solid-svg-icons";
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
const SideBar = props => {
    return (
        <Nav className={"flex-column my-sidebar my-sidebar-expended"}>
            { props.expanded &&
            ...
            { props.expanded &&
                <Nav.Item><Nav.Link as={Link} to="/users"><FontAwesomeIcon icon={faUser} />{' '}Список пользователей</Nav.Link></Nav.Item>
            }
            { !props.expanded &&
